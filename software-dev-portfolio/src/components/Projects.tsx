...
const Projects = () => {
    ...
    const projectsArray: ProjectData[] = [
        {id: 1, title: "Rekindled", img: rekindledImg, description: "Rekindled is a 3D Third Person game", category: "games", year: "2026",
            ...
            descriptions: [
                ...
                {id: 2, title: "Decisions", decisions: "1. My first though was not implementing manual reset because we would need to modify every script in the level to make them work with manual reset, causing major bugs without proper testing, but at the same time, the performance might get worse if the level gets bigger or contains more objects.\n\n" +
    ...
    return (
        <div className="projects-container">
            <h1>Projects</h1>
            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>All Disciplines</button>
            ...
            {isDropdownOpen && (
                ...
                >
                    ...
                    <li onClick={() => setFilter('games')}>Games</li>
                    <li onClick={() => setFilter('web')}>Web</li>
                    <li onClick={() => setFilter('mobile')}>Mobile</li>
                </ul>
            )}
